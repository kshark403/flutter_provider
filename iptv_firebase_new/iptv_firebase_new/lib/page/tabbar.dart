  ...
  void initState() {
    ...
    switch (widget.userType) {
      case UserType.ADMIN:
        tabItems = [];
        tabItems.add(
            TabBarItem(Icons.dashboard, "Dashboard", Profile("Dashboard")));
        tabItems.add(TabBarItem(
            Icons.live_tv, "Live", SectionScreen(Section.LIVE, "Live")));
        tabItems.add(TabBarItem(Icons.slow_motion_video_rounded, "Movies",
            SectionScreen(Section.Movies, "Movies")));
        tabItems.add(TabBarItem(Icons.video_call_sharp, "Series",
            SectionScreen(Section.Series, "Series")));
        break;
      case UserType.USER:
        tabItems = [];
        tabItems.add(TabBarItem(
